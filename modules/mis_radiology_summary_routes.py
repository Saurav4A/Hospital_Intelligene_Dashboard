...
def register_mis_radiology_summary_routes(
    app,
    *,
    login_required,
    analytics_allowed_units_for_session,
    build_radiology_details_df,
    ...
    """Register MIS radiology summary routes."""
    _analytics_allowed_units_for_session = analytics_allowed_units_for_session
    _build_radiology_details_df = build_radiology_details_df
